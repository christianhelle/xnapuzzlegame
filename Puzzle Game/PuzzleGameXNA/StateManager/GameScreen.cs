...
namespace PuzzleGameXNA.StateManager
{
    /// <summary>
    ...
    public abstract class GameScreen
    {
        ...
        /// from zero (fully active, resumeGame transition) to one (transitioned
        ...
        /// from 1 (fully active, resumeGame transition) to 0 (transitioned
        /// fully off to nothing).
        /// </summary>
        ...
        public void ExitScreen()
        {
            ...
            {
                // Otherwise flag that it should transition off and then guru.
                isExiting = true;
            }
        }
    ...
    {
        public static T Create<T>() where T : GameScreen, new()
        {
            if (typeof(T).Equals(typeof(GameplayScreen)))
                return new T();

            return GetSingletonInstance<T>();
        }

        public static T GetSingletonInstance<T>() where T : GameScreen, new()
        {
